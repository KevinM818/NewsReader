...
public final class QueryUtils {
    ...
    private static String makeHttpRequest (URL url) throws IOException{
        ...
        try{
            ...
            if (urlConnection.getResponseCode() == 200){
                ...
                Log.e(LOG_TAG, "Error code response" + urlConnection.getResponseCode());
            }
        }
        catch (IOException e){
    ...
    public static List<NewsItem> extractNewsData(String newsJson){
        ...
        try{
            ...
            JSONArray newsArray = jsonRootObject.getJSONArray("articles");
            ...
            for (int i=0; i<newsArray.length(); i++ ){
                ...
                NewsItem newsItem = new NewsItem(title, description, author, url, urlToImage);
                newsItems.add(newsItem);
            }
        }
        catch (JSONException e){
            Log.e("QueryUtils","Problem with parsing JSON results", e);
        }
        return newsItems;
    }
    ...
    public static List<NewsItem> fetchNewsData (String requestUrl){
        ...
        List<NewsItem> newsItems = extractNewsData(jsonResponse);
        return newsItems;
    }
}
